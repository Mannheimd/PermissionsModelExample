...
CREATE TABLE [dbo].[Roles] (
    ...
    [AllowsClaim] INT            NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
PRINT N'Creating [dbo].[UserRoleClaims]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '10722001-73e4-46e5-a672-5d1c5c344dc8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('10722001-73e4-46e5-a672-5d1c5c344dc8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '504c3eb0-f41e-44f6-840d-3d1477df5ca9')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('504c3eb0-f41e-44f6-840d-3d1477df5ca9')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'ebbb0a5b-cd2e-42d3-b468-35b726012ca7')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('ebbb0a5b-cd2e-42d3-b468-35b726012ca7')
